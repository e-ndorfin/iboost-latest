...
def addclass(request): 
    ...
    if request.method == 'POST':
        profile = Profile(user=request.user.profile)
        joinclassform = JoinClassForm(request.POST, instance=profile)
        
        if joinclassform.is_valid(): 
            print('running')    
            print (joinclassform.cleaned_data)
            joinclassform.save()
            # joinclassform.save().profile = request.user.profile
            # joinclassform.save()
            
        else: 
            print (joinclassform.errors)
            print (joinclassform.cleaned_data)
            # joinclassform.profile = request.user.username
            # print (joinclassform.save(commit=False).profile)
            # print (joinclassform.cleaned_data)
        ...
        # print (joinclassform.save)
        # joinclassform.profile = request.user.username
        # print (joinclassform.profile)
        # # logger.warning(joinclassform.objects.all().values())
        # print (joinclassform.errors)
        # if joinclassform.is_valid():
        #     print ('yay!')
        #     joinclassform.save(commit=False)
        #     joinclassform.profile = request.user.username
